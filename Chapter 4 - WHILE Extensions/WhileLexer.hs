...
alex_table = listArray (0 :: Int, 5456)
  [ 0
  , 38
  , 38
  , 38
...
alex_check = listArray (0 :: Int, 5456)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_10 = const BEGIN
alex_action_11 = const END
alex_action_12 = const VAR
alex_action_13 = const PROC
alex_action_14 = const IS
alex_action_15 = const CALL
...
#endif
{-# LINE 62 "WhileLexer.x" #-}
data Token = LITERAL_INT NumLit        -- | LITERAL_INT Integer
           | IDENTIFIER String         -- | Var, PName, String
           | PLUS
           | MINUS
           | ASTERISK
           | LPAREN
